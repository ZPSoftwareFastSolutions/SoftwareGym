...
export function HeroSectionV2({ hero, slug, sedes }: HeroProps) {
  return (
        ...
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <Reveal delay={300}>
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-6 w-full sm:w-auto">
              <LinkButton
                href={tenantHref(slug, `v2/${hero.primaryCta.segment}`)}
                size="lg"
              ...
              {hero.secondaryCta && (
                <LinkButton
                  href={tenantHref(slug, `v2/${hero.secondaryCta.segment}`)}
                  variant="outline"
                  size="lg"
