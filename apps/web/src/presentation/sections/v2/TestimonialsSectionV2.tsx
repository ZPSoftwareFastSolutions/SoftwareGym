...
import type { Testimonial } from '@core/domain/tenant/tenant-config';
...
export function TestimonialsSectionV2({ testimonials }: TestimonialsProps) {
              ...
              <article className="relative h-full p-8 rounded-[32px] bg-white/5 backdrop-blur-sm border border-white/10 flex flex-col transition-all hover:bg-white/10 hover:-translate-y-2 hover:shadow-[0_10px_40px_rgba(0,0,0,0.5)]">
                ...
                <footer className="flex items-center gap-4">
                  <div className="flex-1">
                    ...
                    <div className="text-action text-sm font-medium uppercase tracking-wider">{t.role}</div>
                  </div>
                </footer>
              </article>
            </Reveal>
