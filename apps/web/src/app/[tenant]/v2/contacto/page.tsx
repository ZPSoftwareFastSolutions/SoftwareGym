...
import { ContactFormV2 } from '@/presentation/sections/v2/ContactFormV2';
...
export default async function V2ContactoPage({ params }: TenantPageParams) {
    ...
    <div className="relative flex flex-col min-h-screen z-10 bg-transparent pb-10">
      ...
      <section className="shell max-w-7xl mx-auto py-20 relative">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-12 items-start">
          ...
          <Reveal delay={100}>
            <ContactFormV2 contact={contact} name={name} sedes={sedes} />
          </Reveal>
        </div>
      </section>
      ...
      <div className="mt-20">
        <FaqSectionV2 items={content.faq} />
      </div>
    </div>
  );
}
